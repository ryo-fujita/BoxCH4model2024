%% e.g., samexaxis([],'YAxisLocation','left','XMinorTick','on','Join','YTickAntiClash','YLabelDistance',0.5) %y軸ラベルは全て左側
%% samexaxis([],'YAxisLocation','alt2','XMinorTick','on','Join','YTickAntiClash','YLabelDistance',0.5)       %y軸ラベルは交互
...
% 17 October, 2019
%Args=struct('YAxisLocation','alt2','XAxisLocation','bottom','Box','on','XLim',[],'XTick',[],'XTickLabel',[],'XMinorTick',[],'YLabelDistance',1.4,'ABC',false,'Join',false,'YTickAntiClash',false); %y軸のラベルを交互にするパターン 
...
switch lower(Args.YAxisLocation)
    ...
    case {'left' 'right'} % 17 October, 2019 R.Fujita
